...
//   Widget build(BuildContext context) {
//     return MaterialApp(
//       home: KakaoMapScreen(), // KakaoMapScreen을 홈 화면으로 설정
//     );
//   }
// }

// // KakaoMapScreen 위젯: 카카오 지도를 보여주는 화면
// class KakaoMapScreen extends StatefulWidget {
//   @override
//   _KakaoMapScreenState createState() => _KakaoMapScreenState();
// }
...
// class _KakaoMapScreenState extends State<KakaoMapScreen> {
//   bool isMapView = true; // 지도를 볼 것인지, 목록을 볼 것인지 여부를 결정하는 변수
//   final List<Meeting> meetings = [];
...
//     return Scaffold(
//       appBar: AppBar(
//         title: Text('Kakao Map Example'), // 앱바 제목 설정
//       ),
//       body: Stack(
//         children: [
//           KakaoMapView(), // KakaoMapView 위젯을 화면에 표시
//           if (!isMapView)
//             DraggableScrollableSheet(
//               initialChildSize: 0.5,
//               minChildSize: 0.25,
...
//               onPressed: () {
//                 setState(() {
//                   isMapView = !isMapView; // 버튼을 누르면 지도 보기와 목록 보기를 전환
//                 });
//               },
//               child: Text(
//                 isMapView ? '목록보기' : '지도보기', // 버튼 텍스트 설정
//                 textAlign: TextAlign.center,
//                 style: TextStyle(fontSize: 12),
//               ),
//             ),
...
// longitude: longitude,
// latitude: latitude,
// creatorId: 'user123', // 모임 생성자 아이디 추가
// ); 
// setState(() {
//   meetings.add(newMeeting);
//   _titleController.clear();
...
// // KakaoMapView 위젯: 카카오 지도를 웹뷰로 표시
// class KakaoMapView extends StatelessWidget {
// @override
// Widget build(BuildContext context) {
// return WebView(
// initialUrl: 'https://map.kakao.com/', // 카카오 지도 URL 설정
